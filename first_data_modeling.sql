...
/* 1 MILHÃO DE REGISTROS PARA CONTAR */

SELECT COUNT(*) FROM CLIENTE;

SELECT SEXO, COUNT(*) FROM CLIENT
GROUP BY SEXO;
...
/* UTILIZANDO O UPDATE PARA ATUALIZAR VALORES DA TABELA */

-- USE SEMPRE UM SELECT ANTES DO UPDATE PARA CONFIRMAR SE O DADO É MESMO O DADO CORRETO A SER ATUALIZADO
SELECT NOME, EMAIL
FROM CLIENTE;

UPDATE CLIENTE
SET EMAIL = 'MARY@HOTMAIL.COM';

SELECT NOME, EMAIL
FROM CLIENTE;

/* WHERE - VAR SER O SEU MELHOR AMIGO DA VIDA */
...
/* COMMIT E ROLLBACK */ -- COMANDOS PARA VOLTAR ATRÁS

/* DELETANDO REGISTROS COM A CLAUSULA DELETE */

DELETE FROM CLIENTE; -- DELETA A TABELA INTEIRA
...
INSERT INTO CLIENTE VALUES('INÁCIO','M','INACIO@TESTE.COM',192837465,'99123456','MARCOLINO SIMÕES FERREIRA - ITAMARATI - PETROPOLIS - RJ');

SELECT * FROM CLIENTE;

DELETE FROM CLIENTE
WHERE NOME = 'INACIO'
OR EMAIL = 'AFONSO@TESTE.COM';

SELECT * FROM CLIENTE 
WHERE NOME = 'INACIO'
OR EMAIL = 'AFONSO@TESTE';
...
[AMARELO, AZUL, VERMELHOR] -> CORES
[KA, PALIO, CIVIC, GOL] -> CARROS
...
CREATE TABLE ENDERECO(
    ...
    ID_CLIENTE INT UNIQUE, -- UNIQUE PARA RELAÇÕES 1 X 1
...
/* CHAVEE ESTRANGEIRA É A CHAVE PRIMÁRIA DE UMA TABELA
...
/* PROJECAO -> É TUDO O QUE VOCÊ QUER VER NA TELA */
...
/* QUANTIDADE DE HOMENS MULHERES*/
SELECT COUNT(*) AS QUANTIDADE, SEXO
FROM CLIENTE
GROUP BY SEXO;

/* IDs E EMAILS DAS MULHERES QUE MOREM NO CENTRO DO RIO DE JANEIRO E NÃO TINHA CELULAR */
